...
/datum/advclass/sentinel
	name = "Sentinel"
	tutorial = "Elvish Sentinels are a specialized group of ranger-folk known for their mastery of bow and blade alike; their arrows are said to contain poisons from the native trees"
